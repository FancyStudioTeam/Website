		...
		>
			<header className='flex items-center gap-4'>
				...
				<div className='flex flex-col gap-1 overflow-hidden'>
					...
					<span className='w-fit truncate rounded-full bg-light-tertiary px-2 py-0.5 text-foreground text-light-foreground text-xs dark:bg-dark-tertiary dark:text-dark-foreground'>
						{ROLE_NAMES[role]}
					</span>
				</div>
			</header>
